...
## [0.2.6](https://github.com/mathematic-inc/vscode-pdf/compare/v0.2.5...v0.2.6) (2026-09-24)


### Bug Fixes

* **deps:** Preserve VS Code engine compatibility ([53fcab2](https://github.com/mathematic-inc/vscode-pdf/commit/53fcab2e46fd7f3420f269100fb2178cc36b4ee5))
* **deps:** Preserve VS Code engine compatibility ([#94](https://github.com/mathematic-inc/vscode-pdf/issues/94)) ([babb88d](https://github.com/mathematic-inc/vscode-pdf/commit/babb88d912a10cafb4edec0dd979c017d34cd8ef))
* **deps:** Remediate vulnerable transitive packages ([#85](https://github.com/mathematic-inc/vscode-pdf/issues/85)) ([594122c](https://github.com/mathematic-inc/vscode-pdf/commit/594122cb5bbc5a4560acf0b7b3cbfde2646de01f))

## [0.2.5](https://github.com/mathematic-inc/vscode-pdf/compare/v0.2.4...v0.2.5) (2026-09-05)


### Bug Fixes

* **ci:** Harden release workflows and repository checks ([#70](https://github.com/mathematic-inc/vscode-pdf/issues/70)) ([ac49c0f](https://github.com/mathematic-inc/vscode-pdf/commit/ac49c0fbcbf55f7e0ed909c11531dec3a043dfdb))
...
* Avoid delayed PDF worker startup ([#64](https://github.com/mathematic-inc/vscode-pdf/issues/64)) ([6feb85a](https://github.com/mathematic-inc/vscode-pdf/commit/6feb85a1cea516eed2c9e5026831cc5965e43236))

## [0.2.2](https://github.com/mathematic-inc/vscode-pdf/compare/v0.2.1...v0.2.2) (2026-08-27)


### Bug Fixes

* Wait for PDF pages before fragment navigation ([#61](https://github.com/mathematic-inc/vscode-pdf/issues/61)) ([5eb7011](https://github.com/mathematic-inc/vscode-pdf/commit/5eb70112a54b89644704579d6993d32cbefee053))

## [0.2.1](https://github.com/mathematic-inc/vscode-pdf/compare/v0.2.0...v0.2.1) (2026-08-27)

### Bug Fixes

- Require VS Code `^1.134.0` to match the bundled VS Code API types ([#57](https://github.com/mathematic-inc/vscode-pdf/issues/57)) ([07fb8dc](https://github.com/mathematic-inc/vscode-pdf/commit/07fb8dc8329ce68dcd16e2158e11a6f5aec930c1))

## [0.2.0](https://github.com/mathematic-inc/vscode-pdf/compare/v0.1.11...v0.2.0) (2026-08-27)

### ⚠ BREAKING CHANGES

- Require VS Code `^1.95.0`.

### Features

- Update to PDF.js 6.2.108 and load viewer resources through VS Code webview URIs.
- Match the PDF viewer to VS Code light, dark, and high-contrast themes.

### Bug Fixes

- **security:** Validate webview message origins and restrict local PDF links to the current resource root ([#55](https://github.com/mathematic-inc/vscode-pdf/issues/55)) ([fa72f6a](https://github.com/mathematic-inc/vscode-pdf/commit/fa72f6a66162d5814fe14cb0398509d5dcd30237))

### Maintenance

- Use hk, Oxlint, Oxfmt, strict TypeScript checks, Dependabot, and hardened CI.
